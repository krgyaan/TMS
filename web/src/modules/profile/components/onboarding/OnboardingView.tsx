...
import { User, FileText, ClipboardCheck, CheckCircle2, XCircle, Sparkles, ArrowRight, Shield, CreditCard, GraduationCap, Briefcase } from "lucide-react";
...
function buildDocumentDetails(data: any): DocumentDetail[] {
    ...
    return data.documents.map((d: any) => ({
        ...
        status: d.verificationStatus === "approved" ? "rejected" : d.verificationStatus === "rejected" ? "rejected" : "pending",
        ...
        return (
            <div className="space-y-6">
                ...
                <div className="rounded-3xl border border-border/40 bg-background/50 backdrop-blur-xl p-6 sm:p-8 shadow-2xl">
                    ...
                    <OnboardingProfileForm onCancel={() => setEditingStage(null)} onSuccess={handleCloseForm} />
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="space-y-6">
                ...
                <div className="rounded-3xl border border-border/40 bg-background/50 backdrop-blur-xl p-6 sm:p-8 shadow-2xl">
                    ...
                    <OnboardingBankForm onCancel={() => setEditingStage(null)} onSuccess={handleCloseForm} />
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="space-y-6">
                ...
                <div className="rounded-3xl border border-border/40 bg-background/50 backdrop-blur-xl p-6 sm:p-8 shadow-2xl">
                    ...
                    <OnboardingEducationForm onCancel={() => setEditingStage(null)} onSuccess={handleCloseForm} />
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="space-y-6">
                ...
                <div className="rounded-3xl border border-border/40 bg-background/50 backdrop-blur-xl p-6 sm:p-8 shadow-2xl">
                    ...
                    <OnboardingExperienceForm onCancel={() => setEditingStage(null)} onSuccess={handleCloseForm} />
                </div>
            </div>
        );
    }
                ...
                {STAGES_CONFIG.map((stage, index) => {
                    ...
                    return (
                        <OnboardingStageCard
                            ...
                            isSubmitted={stageStatus === "submitted"}
                            index={index}
                            ...
                            details={stage.key === "profile" ? profileDetails : stage.key === "bank" ? bankDetailsSummary : undefined}
