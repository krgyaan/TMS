...
const create = () => {
  ...
  const handleManualSubmit: SubmitHandler<FormValues> = (values) => {
    const fileNames = toFiles(values.documents as unknown).map(
      (file) => file.name
    );
  ...
  return (
    <Card className="">
      ...
      <CardContent>
        <Tabs defaultValue="useAi" className="w-full cursor-pointer">
            ...
            <Form {...manualForm}>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <FieldWrapper<FormValues, "teamName">
                    control={manualForm.control}
                    name="teamName"
                    label={"Team Name: AC/DC"}
                  >
                    {(field) => <Input placeholder="AC/DC" {...field} />}
                  </FieldWrapper>

                  <FieldWrapper<FormValues, "tenderNo">
                    control={manualForm.control}
                    name="tenderNo"
                    label={"Tender No"}
                  >
                  ...
                  <FieldWrapper<FormValues, "tenderName">
                    control={manualForm.control}
                    name="tenderName"
                    label={"Tender Name"}
                  >
                  ...
                  <FieldWrapper<FormValues, "tenderValue">
                    control={manualForm.control}
                    name="tenderValue"
                  ...
                  <FieldWrapper<FormValues, "tenderFee">
                    control={manualForm.control}
                    name="tenderFee"
                    label={"Tender Fee"}
                  >
