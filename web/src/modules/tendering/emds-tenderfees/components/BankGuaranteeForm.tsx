...
export function BankGuaranteeForm({ control, showPurposeAmount = false, setValue }: BankGuaranteeFormProps) {
    const bgFormatFiles = useWatch({ control, name: "emd.details.bgFormatFiles" });
    const bgPoFiles = useWatch({ control, name: "emd.details.bgPoFiles" });
