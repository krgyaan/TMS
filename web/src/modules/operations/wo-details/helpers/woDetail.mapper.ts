...
export const formToApi = {
  ...
  page2(form: Page2FormValues) {
    return {
      ...
      filledBgFormat: form.filledBgFormat?.length ? form.filledBgFormat : null,
      pbgBgId: form.pbgBgId ?? null,
      isContractAgreement: stringToBool(form.isContractAgreement),
      contractAgreementFormat: form.contractAgreementFormat?.length ? form.contractAgreementFormat : null,
