...
export function mapFormToCreateDTO(
    ...
    return {
        ...
        sellerId: values.sellerSource === "vendor_org" ? undefined : values.sellerId ? Number(values.sellerId) : undefined,
        sellerOrganizationId: values.sellerSource === "vendor_org" && values.sellerId ? Number(values.sellerId) : undefined,
