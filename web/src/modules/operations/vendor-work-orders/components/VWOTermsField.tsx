...
import { VWO_TERMS_OPTIONS } from "../helpers/vwoForm.constants";

interface VWOTermsFieldProps {
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Add terms and conditions for this work order
          </p>
        </div>
        <Button
          type="button"
