        ...
        <>
            <Card>
                <CardHeader>
                    ...
                    <CardAction>
                        <Button variant="default" onClick={() => setDrawerState({ open: true, status: null })}>
            ...
            />
            <StatusViewModal open={viewState.open} onOpenChange={open => setViewState({ ...viewState, open })} status={viewState.status} />
        </>
    );
};
