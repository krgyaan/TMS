        ...
        <>
            <Card>
                <CardHeader>
                    ...
                    <CardAction>
                        <Button variant="default" onClick={() => setDrawerState({ open: true, location: null })}>
            ...
            />
            <LocationViewModal open={viewState.open} onOpenChange={open => setViewState({ ...viewState, open })} location={viewState.location} />
        </>
    );
};
