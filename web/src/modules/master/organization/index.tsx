        ...
        <>
            <Card>
                <CardHeader>
                    ...
                    <CardAction>
                        <Button variant="default" onClick={() => setDrawerState({ open: true, organization: null })}>
            ...
            />
            <OrganizationViewModal open={viewState.open} onOpenChange={open => setViewState({ ...viewState, open })} organization={viewState.organization} />
        </>
    );
};
