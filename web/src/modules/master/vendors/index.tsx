    ...
    const organizationActions: ActionItem<VendorOrganizationWithRelations>[] = [
        ...
        },
        {
            ...
            onClick: async (row) => {
                if (
                    confirm(
                        `Are you sure you want to delete "${row.name}"? This will also remove all associated vendors, GSTs, accounts, and files.`,
                    )
                ) {
                    try {
            ...
            >
                <DialogContent className="max-w-2xl max-h-[80vh]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Total Files: {filesModal.data.length}
                        </DialogDescription>
                    </DialogHeader>
                    <div className="mt-4 max-h-[60vh] overflow-y-auto pr-2">
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-start justify-between">
                                                ...
                                                <Badge variant={file.status ? 'default' : 'secondary'}>
