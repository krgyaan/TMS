...
const FinanceDocumentShowPage = () => {
    ...
    // const { data: financeDocument, isLoading } = useFinanceDocument(financeDocumentId);
        ...
        <Card>
            <CardHeader>
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button variant="outline" onClick={() => navigate(`/document-dashboard/finance-document/${financeDocumentId}/edit`)}>
            ...
            <CardContent>
                <div className="text-center text-muted-foreground py-8">
                    <p>Finance Document details will be displayed here</p>
