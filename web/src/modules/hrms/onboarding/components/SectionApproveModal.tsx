...
export const SectionApproveModal: React.FC<{
  open: boolean;
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <DialogDescription className="mt-0.5 text-xs">
                {isApprove
                  ? "This will approve all records in this section."
                  : "This will reject all records in this section."}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
            ...
            <Textarea
              ...
              placeholder={
                isApprove
                  ...
                  : "e.g. Incomplete or invalid details."
              }
              rows={3}
