...
import { useFileConfig, useFileUpload } from '@/hooks/api/useFileUpload';
import { fileUploadService } from '@/services/api/file-upload.service';
import type { FileContext, FileConfig } from './types';
import { parseFileMeta } from './helpers/fileMeta';
