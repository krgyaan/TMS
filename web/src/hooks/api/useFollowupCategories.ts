...
export const useFollowupCategories = () => {
    return useQuery({
...
export const useFollowupCategory = (id: number | null) => {
    return useQuery({
...
export const useCreateFollowupCategory = () => {
...
export const useUpdateFollowupCategory = () => {
    const queryClient = useQueryClient();
...
// export const useDeleteFollowupCategory = () => {
//     const queryClient = useQueryClient();
