...
export const useCreateDesignation = () => {
    ...
    return useMutation({
        mutationFn: (data: CreateDesignationDto) => followupCategoriesService.create(data),
        onSuccess: () => {
...
export const useUpdateDesignation = () => {
    ...
    return useMutation({
        mutationFn: ({ id, data }: { id: number; data: UpdateDesignationDto }) => followupCategoriesService.update(id, data),
