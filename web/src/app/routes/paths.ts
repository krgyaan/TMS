export const paths = {
    ...
    operations: {
        ...
        raiseVendorWoInvoiceForm: (projectId: number, vwoId?: number) =>
            `/operations/project-dashboard/${projectId}/project-purchase-invoice/create${vwoId ? `?vwoId=${vwoId}` : ''}`,
    ...
    services: {
        ...
        conferenceCreate: "/services/conference/create",
        conferenceView: (id: number | string) => `/services/conference/${id}/view`,
        conferenceShow: (id: number | string) => `/services/conference/${id}`,
        visit: "/services/visit",
        visitCreate: "/services/visit/create",
        visitView: (id: number | string) => `/services/visit/${id}/view`,
        visitShow: (id: number | string) => `/services/visit/${id}`,
        feedback: "/services/feedback",
        feedbackForm: "/services/feedback/form",
        feedbackView: (id: number | string) => `/services/feedback/${id}/view`,
        feedbackShow: (id: number | string) => `/services/feedback/${id}`,
        amc: "/services/amc",
    ...
    accounts: {
        ...
        insuranceCreate: "/accounts/insurance/create",
        insuranceEdit: (id: number) => `/accounts/insurance/${id}/edit`,
        insuranceView: (id: number) => `/accounts/insurance/${id}`,
    ...
    crm: {
        ...
        happyCallingFollowupHistory: (id: number | string) => `/crm/happy-calling/followup/${id}/history`,
    },
