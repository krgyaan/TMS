export const paths = {
    ...
    operations: {
        ...
        kickOffShowPage: (id: number) => `/operations/kick-off/${id}`,
        contractAgreementListPage: "/operations/contract-agreement",
        contractAgreementCreatePage: "/operations/contract-agreement/create",
        contractAgreementEditPage: (id: number) => `/operations/contract-agreement/${id}/edit`,
        contractAgreementShowPage: (id: number) => `/operations/contract-agreement/${id}`,
