...
// Projects
const Master_Project = lazy(() => import("@/modules/shared/project"));
const Master_Project_Create = lazy(() => import("@/modules/shared/project/create"));
const Master_Project_Edit = lazy(() => import("@/modules/shared/project/edit"));
        ...
        <Routes>
            ...
            <Route path="document-submitted">
                ...
                <Route
                    ...
                    element={
                        <RouteWrapper>
                            <Master_DocumentSubmitted_Create />
                        </RouteWrapper>
                    }
                />
                <Route
            ...
            <Route path="followup-categories">
                ...
                <Route
                    ...
                    element={
                        <RouteWrapper>
                            <Master_FollowupCategory_Create />
                        </RouteWrapper>
                    }
                />
                <Route
            ...
            <Route path="emds-responsibilities">
                ...
                <Route
                    ...
                    element={
                        <RouteWrapper>
                            <Master_EMDResponsibility_Create />
                        </RouteWrapper>
                    }
                />
                <Route
