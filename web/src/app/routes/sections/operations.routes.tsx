...
// Consolidated show page for all work order detail views
const WoShowPage = lazy(() => import("@/modules/operations/components/WoShowPage"));
...
export default function OperationsRoutes() {
    return (
        <Routes>
            ...
            <Route path="work-order/details/basic/:id" element={<RouteWrapper><WoShowPage /></RouteWrapper>} />
            ...
            <Route path="work-order/details/full/:id" element={<RouteWrapper><WoShowPage /></RouteWrapper>} />
            ...
            <Route path="work-order/kick-off/:id" element={<RouteWrapper><WoShowPage /></RouteWrapper>} />

            <Route path="work-order/contract-agreement" element={<RouteWrapper><Operations_ContractAgreement /></RouteWrapper>} />
            <Route path="work-order/contract-agreement/:id" element={<RouteWrapper><WoShowPage /></RouteWrapper>} />
            ...
            <Route path="project-dashboard/purchase-order/:id" element={<RouteWrapper><Operations_ViewPoPage /></RouteWrapper>} />
            <Route path="project-dashboard/purchase-order/:id/edit" element={<RouteWrapper><Operations_EditPOPage /></RouteWrapper>}></Route>
        </Routes>
    );
}
