...
export default function TenderingRoutes() {
    return (
        <Routes>
            <Route path="tenders" element={<RouteWrapper permission={{ module: "tenders", action: "read" }}><Tendering_Tenders /></RouteWrapper>} />
            ...
            <Route path="results/:id/edit" element={<RouteWrapper><Tendering_Result_Upload /></RouteWrapper>} />
