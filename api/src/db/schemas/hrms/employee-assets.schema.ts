...
export const employeeAssets = pgTable('hrms_employee_assets', {
  ...
  assetCondition:      varchar('asset_condition', { length: 20 }).default('new'),
  ...
  typeSpecs:           jsonb('type_specs').default({}),
  ...
  assetStatus:         varchar('asset_status', { length: 50 }).notNull().default('available'),
