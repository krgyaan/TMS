...
export const assetTrackingHistory = pgTable('hrms_asset_tracking_history', {
  ...
  disposalType: varchar('disposal_type', { length: 50 }),
  disposalReason: text('disposal_reason'),
  disposalAmount: numeric('disposal_amount', { precision: 12, scale: 2 }),
  disposalApprovedBy: varchar('disposal_approved_by', { length: 255 }),
