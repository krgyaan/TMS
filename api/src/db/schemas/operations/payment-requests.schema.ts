...
export const paymentRequests = pgTable(
    "project_payment_requests",
    {
        ...
        uploadInvoice: jsonb("upload_invoice").notNull().default([]),
        uploadPI: jsonb("upload_pi").notNull().default([]),
        uploadInvoiceAfterPayment: jsonb("upload_invoice_after_payment").notNull().default([]),
        remark: text("remark"),
