...
@Module({
    ...
    providers: [ChequeService, PaymentRequestsService, TenderInfosService, TenderStatusHistoryService, EmailService, RecipientResolver, GmailClient, TenderFilesService],
