...
export const DD_STATUSES = {
    PENDING: 'DD_ACCOUNTS_FORM_PENDING',
...
export const FDR_STATUSES = {
    PENDING: 'FDR_ACCOUNTS_FORM_PENDING',
...
export const CHEQUE_STATUSES = {
    PENDING: 'CHEQUE_ACCOUNTS_FORM_PENDING',
...
export const BG_STATUSES = {
    PENDING: 'BG_ACCOUNTS_FORM_PENDING',
    ACCOUNTS_FORM_ACCEPTED: 'BG_ACCOUNTS_FORM_ACCEPTED',
    ACCOUNTS_FORM_REJECTED: 'BG_ACCOUNTS_FORM_REJECTED',
    BG_CREATED: 'BG_CREATED',
    FDR_DETAILS_CAPTURED: 'BG_FDR_DETAILS_CAPTURED',
    ...
    BG_CANCELLATION_CONFIRMED: 'BG_BG_CANCELLATION_CONFIRMED',
    FDR_CANCELLED_CONFIRMED: 'BG_FDR_CANCELLED_CONFIRMED',
} as const;
...
export const BG_STAGES = {
    1: {
        ...
        statuses: [
            ...
            BG_STATUSES.ACCOUNTS_FORM_REJECTED,
        ...
        terminalStatuses: [BG_STATUSES.ACCOUNTS_FORM_REJECTED, BG_STATUSES.BG_CANCELLATION_CONFIRMED, BG_STATUSES.FDR_CANCELLED_CONFIRMED],
        nextStages: [2],
    },
    2: {
    ...
    3: {
        ...
        statuses: [BG_STATUSES.FDR_DETAILS_CAPTURED],
        terminalStatuses: [],
        nextStages: [4, 5, 6, 7],
    },
    4: {
    ...
    9: {
        ...
        statuses: [BG_STATUSES.FDR_CANCELLED_CONFIRMED],
        terminalStatuses: [],
        nextStages: [],
    },
};
...
export const BT_STATUSES = {
    PENDING: 'Bank Transfer_ACCOUNTS_FORM_PENDING',
    ACCOUNTS_FORM_ACCEPTED: 'Bank Transfer_ACCOUNTS_FORM_ACCEPTED',
    ACCOUNTS_FORM_REJECTED: 'Bank Transfer_ACCOUNTS_FORM_REJECTED',
    FOLLOWUP_INITIATED: 'Bank Transfer_FOLLOWUP_INITIATED',
    RETURN_VIA_BANK_TRANSFER: 'Bank Transfer_RETURN_VIA_BANK_TRANSFER',
    SETTLED_WITH_PROJECT: 'Bank Transfer_SETTLED_WITH_PROJECT',
} as const;
...
export const PORTAL_STATUSES = {
    PENDING: 'Portal Payment_ACCOUNTS_FORM_PENDING',
    ACCOUNTS_FORM_ACCEPTED: 'Portal Payment_ACCOUNTS_FORM_ACCEPTED',
    ACCOUNTS_FORM_REJECTED: 'Portal Payment_ACCOUNTS_FORM_REJECTED',
    FOLLOWUP_INITIATED: 'Portal Payment_FOLLOWUP_INITIATED',
    RETURN_VIA_BANK_TRANSFER: 'Portal Payment_RETURN_VIA_BANK_TRANSFER',
    SETTLED_WITH_PROJECT: 'Portal Payment_SETTLED_WITH_PROJECT',
} as const;
