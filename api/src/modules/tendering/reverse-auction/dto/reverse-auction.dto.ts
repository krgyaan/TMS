...
export const UploadRaResultSchema = z.object({
    ...
    raClosePriceL2: optionalNumber(z.coerce.number().min(0, 'L2 close price must be non-negative')),
    raOurPrice: optionalNumber(z.coerce.number().min(0, 'Our price must be non-negative')),
