...
export const FOLLOWUP_WINDOWS: FollowupWindow[] = [
    // Daily — 5:00 PM Mon–Sat
    { hour: 17, minute: 0, days: [1, 2, 3, 4, 5, 6], frequency: 1 },

    // Alternate — 5:00 PM Mon–Sat
    { hour: 17, minute: 0, days: [1, 2, 3, 4, 5, 6], frequency: 2 },

    // Weekly — Monday 5:00 PM
    { hour: 17, minute: 0, days: [1], frequency: 3 },

    // Bi-Weekly — 5:00 PM Mon–Sat
    { hour: 17, minute: 0, days: [1, 2, 3, 4, 5, 6], frequency: 4 },

    // Monthly-like — Mon & Thu 5:00 PM
    { hour: 17, minute: 0, days: [1, 4], frequency: 5 },
];
