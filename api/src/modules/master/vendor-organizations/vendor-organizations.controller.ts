...
export class VendorOrganizationsController {
    constructor(private readonly vendorOrganizationsService: VendorOrganizationsService) {}
    ...
    async updateWithRelations(@Param("id", ParseIntPipe) id: number, @Body() body: unknown) {
