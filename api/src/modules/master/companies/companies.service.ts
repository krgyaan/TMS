...
import { companies, type Company } from '@db/schemas/master/companies.schema';
import {
    companyDocuments,
    type CompanyDocument,
} from '@db/schemas/master/company-documents.schema';
import type {
    CompanyDetailsDto,
    CompanyDocumentsDto,
} from '@/modules/master/companies/companies.controller';
