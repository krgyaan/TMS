...
//                     issueDate: row.bg_date || null,
//                     expiryDate: Parsers.dateString(row.bg_expiry) || null,
//                     validityDate: row.bg_validity || null,
//                     claimExpiryDate: row.claim_expiry || null,
//                     docketNo: Parsers.string(row.docket_no, 255) || null,
...
//                     newBgClaim: row.new_bg_claim || null,
...
//                     fdrValidity: row.fdr_validity || null,
//                     fdrRoi: fdrRoi,
