...
class OcrEngine:
    ...
    def _init_paddle(cls):
        ...
        if not cls._paddle_attempted:
            ...
            try:
                ...
                import logging
                logging.getLogger("app.ocr.ocr_engine").info("[OCR_DIAGNOSTICS] PaddleOCR initialized successfully as primary OCR engine.")
            except Exception as e:
                import logging
                logging.getLogger("app.ocr.ocr_engine").warning(
    ...
    def _verify_languages(lang: str) -> str:
        ...
        try:
            ...
            import logging
            logging.getLogger("app.ocr.ocr_engine").debug(f"[OCR_DIAGNOSTICS] Language verification skipped: {e}")
        return lang
